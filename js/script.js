    ...
    */
    ...
    var init = (function()
    {
        ...
        */
        ...
        {
            planetas[i].objeto = crearPlaneta({tamano : 50,
    ...
    var puntoDeVista = function()
	{
        ...
        for(var i = 0; i < planetas.length ; i++)
        {
            ...
            {
                if(!planetas[i].veplaneta)
                {
                    planetas[i].veplaneta = true;
                    console.log(planetas[i].nombre);
                    //responsiveVoice.speak("Estas viendo un planeta llamado "+planetas[i].nombre, "Spanish Female");
                }

            }
             else
                {
                    planetas[i].veplaneta = false;
                }
        }
  	};
    ...
    var animate = function()
    {
        ...
        for(var i = 0; i < planetas.length; i++)
        {
         planetas[i].objeto.rotation.y += 0.09;
        }
        puntoDeVista();
